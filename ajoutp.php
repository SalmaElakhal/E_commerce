...
<div class="col--sm-6">
    <input type="text" class="form-control" name="nomproduit" placeholder="Entrer le nom de produit">
</div>
<div class="mb-3">
<label class="form-label">Prix Unitaire:</label>
    <input type="number" class="form-control" name="prixunitaire" placeholder="Entrer le prix du produit">
</div>
<div class="mb-3">
<label class="form-label">Quantite de Stock:</label>
    <input type="number" class="form-control" name="qtestock" placeholder="Entrer la Quantite de Stock">
</div>
<div class="form-group mb-3">
  <label >Indisponible:</label> &nbsp;
  <input type="radio" class="form-check-input" name="indisponible" id="dispo" value='1'>
<label for="dispo" class="form-input-label">Dispo</label>
&nbsp;
<input type="radio" class="form-check-input" name="indisponible" id="indispo" value='0'>
