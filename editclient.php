...
<body>
<nav class="navbar navbar-light justify-content-center fs-1 mb-5 text-white" style="background:linear-gradient(19deg, #21D4FD 0%, #B721FF 100%);" >Gestion des Clients</nav>
    <div class="container" >
        ...
        <input type="hidden" name="numclient" value="<?php echo $numclient; ?>">
            ...
            <div class=" mb-3">
                <label class="form-label">Adresse Client:</label>
                    ...
                    placeholder="Entrer la raison social"
                    name="adresseclient" value="<?php echo $adresseclient; ?>">
            </div>
            ...
            <div class=" mb-3">
                <label class="form-label">Ville Client:</label>
                    ...
                    name="villeclient" value="<?php echo $villeclient; ?>">
            </div>
            ...
            <div class=" mb-3">
                <label class="form-label">Numero de Telephone:</label>
                    <input type="text" class="form-control"
                    placeholder="Entrer le numero de telephone pays"
